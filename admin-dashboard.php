    ...
    <div class="container-fluid px-4 py-3">
      <div class="row">
        ...
        <div class="col col-lg-10 col-md-12 col-ms-12 mb-5  col-xs-12">
          <h5 class="fw-bolder bg-dark text-white-50 py-3 px-3 fs-4 mt-5">All Books</h5>

          <hr>

          <table id="books" class="table border border-1 table-secondary table-hover table-stripped my-5">
            <thead>
              <tr>
                <th>Id</th>
                <th>Book Name</th>
