...
$id= $_GET['updateid18'];
$sqldisplay4 = "SELECT * from g7 where id = $id";
...
if (isset($_POST['update'])) {
    ...
    if (in_array($file_extension, $extensions)) {
        ...
        $sql = "UPDATE g7 set id=$id,book_name='$bookname',book_prize='$bookprize',book_img='$uploadBookImg',product_quantity='$bookqty' where id=$id";
