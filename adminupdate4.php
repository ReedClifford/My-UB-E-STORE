...
$id= $_GET['updateid4'];
$sqldisplay4 = "SELECT * from gened2 where id = $id";
...
if (isset($_POST['update'])) {
    ...
    if (in_array($file_extension, $extensions)) {
        ...
        $sql = "UPDATE gened2 set id=$id,book_name='$bookname',book_prize='$bookprize',book_img='$uploadBookImg',product_quantity='$bookqty' where id=$id";
        ...
        if ($result) {
            ...
            echo "<script>window.location = 'admin-dashboard.php#section2'</script>";
            # code...
        } else {
            # code...
