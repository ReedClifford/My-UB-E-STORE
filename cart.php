        ...
        <div>
          ...
          <form action="cart.php" method="post">
            <div class="row price-details border border-rounded  shadow p-3 mb-5 bg-body rounded bg-white h-25 my-3 py-5 px-3">
              ...
              <button type="submit" class="btn btn-warning py-3 my-3 fw-bolder text-center "><i class="fas fa-money-bill-alt me-2"></i><a href="checkout.php" class="checkout">Checkout</a></button>
