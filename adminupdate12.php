...
$id= $_GET['updateid12'];
$sqldisplay4 = "SELECT * from abm where id = $id";
...
if (isset($_POST['update'])) {
    ...
    if (in_array($file_extension, $extensions)) {
        ...
        $sql = "UPDATE abm set id=$id,book_name='$bookname',book_prize='$bookprize',book_img='$uploadBookImg',product_quantity='$bookqty' where id=$id";
