...
if (isset($_POST['add'])) {
  ...
  if (isset($_SESSION['cart'])) {
    ...
    echo "<script>window.location = 'uniformmain4.php#section2'</script>";
    if (in_array($_POST['uniform_id'], $uniform_item_id)) {


      echo "<script>alert('Product is already in the cart!!')</script>";
      echo "<script>window.location = 'uniformmain4.php'</script>";
    } else {
      # code...
  ...
  <section id="section2">
    ...
    <div class="container    py-5 my-3">
      ...
      <div id="filter" class="button-group text-end">
        ...
        <a href="uniformmain4.php"><button class="btn border border-2" data-filter=".major">College</button></a>
      ...
      <div class="row">
        ...
        <?php
        $sql = "SELECT * from collegeuniform ORDER by ID asc";
        ...
        while ($row = mysqli_fetch_assoc($result)) {
          ...
          component4($row['name'], $row['prize'], $row['uniform_img'], $row['quantity'], $row['id']);
        }
