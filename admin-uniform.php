  ...
  <section id="section2" class="my-5">
    <div class="container-fluid px-4 py-3">
      <div class="row">
          ...
          <nav class="nav flex-column border border-1 mt-5 nav-pills navbar-light bg-light sticky-top">
            ...
            <div class="bg-dark border  py-2 px-3">
              <a href="admin-dashboard.php" class="navlink">
                <h6 class="fs-6 fw-normal text-white text-wrap"><i class="fas fa-book-open me-2"></i> Books Inventory</h6>
              </a>
            </div>
        ...
        <div class="col col-lg-10 col-md-12 col-ms-12 mb-5  col-xs-12">
          <h5 class="fw-bolder bg-dark text-white-50 py-3 px-3 fs-4 mt-5">Uniforms Inventory</h5>
          <hr>

          <table id="uniform" class="table border border-1 table-secondary table-hover table-stripped my-5">
            <thead>
              <tr>
                <th>Id</th>
                <th>Item Name</th>
            ...
            <tbody>
              ...
              while ($row = mysqli_fetch_assoc($result)) {
                ...
                $bookimg = $row['uniform_img'];
                echo "<tr>
                  <th scope='row'>$id</th>
                  <td>$bookname</td>
                  <td>$bookprice</td>
                  <td >$productqty</td>
                  <td class =\"text-center\"><img src = '$bookimg'/></td>
