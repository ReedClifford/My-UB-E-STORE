...
// create instance
// $database3 = new nursingBooksDb("nursing2", "nursing2");
if (isset($_POST['add'])) {
  // print_r($_POST['book_id']);

  if (isset($_SESSION['cart'])) {
    # code...
    $book_item_id3 = array_column($_SESSION['cart'], "book_id");

    if (in_array($_POST['book_id'], $book_item_id3)) {
      # code...
      echo "<script>alert('Product is already in the cart!!')</script>";
      echo "<script>window.location = 'books3.php#section2'</script>";
    } else {
      # code...
      ...
      $_SESSION['cart'][$count3] = $book_array3;
    }
  } else {
    # code...
    $book_array3 = array(
  ...
  <section id="section2">
    ...
    <div class="container    py-5 my-3">
      ...
      <div id="filter" class="button-group text-end">
        ...
        <a href="books9.php#section2"><button class="btn " data-filter=".major">TechEd</button></a>
      ...
      <div class="row">
        ...
        while ($row = mysqli_fetch_assoc($result)) {
          component3($row['book_name'], $row['book_prize'], $row['book_img'], $row['product_quantity'], $row['id']);
        }
