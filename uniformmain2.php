...
if (isset($_POST['add'])) {
    ...
    if (isset($_SESSION['cart'])) {
        ...
        if (in_array($_POST['uniform_id'], $uniform_item_id)) {
            ...
            echo "<script>window.location = 'uniformmain2.php'</script>";
        } else {
            # code...
    ...
    <section id="section2">
        ...
        <div class="container    py-5 my-3">
            ...
            <div id="filter" class="button-group text-end">
                ...
                <a href="uniformmain2.php"><button class="btn border border-2" data-filter=".major">Junior High</button></a>
            ...
            <div class="row">
                ...
                <?php
                $sql = "SELECT * from jhsuniform ORDER by ID asc";
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    component2($row['name'], $row['prize'], $row['uniform_img'], $row['quantity'], $row['id']);
                }
