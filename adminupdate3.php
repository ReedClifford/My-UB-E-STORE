...
$id= $_GET['updateid3'];
$sqldisplay3 = "SELECT * from nursing2 where id = $id";
$resultdisplay3 = mysqli_query($connect,$sqldisplay3);
$row3 = mysqli_fetch_assoc($resultdisplay3);
$bookname = $row3['book_name'];
$bookprize = $row3['book_prize'];
$bookimg = $row3['book_img'];
$bookqty = $row3['product_quantity'];
...
if (isset($_POST['update'])) {
    ...
    if (in_array($file_extension, $extensions)) {
        ...
        $sql = "UPDATE nursing2 set id=$id,book_name='$bookname',book_prize='$bookprize',book_img='$uploadBookImg',product_quantity='$bookqty' where id=$id";
