...
$id= $_GET['updateid2'];
$sqldisplay2 = "SELECT * from engii2 where id = $id";
$resultdisplay2 = mysqli_query($connect,$sqldisplay2);
$row2 = mysqli_fetch_assoc($resultdisplay2);
$bookname = $row2['book_name'];
$bookprize = $row2['book_prize'];
$bookimg = $row2['book_img'];
$bookqty = $row2['product_quantity'];
...
if (isset($_POST['update'])) {
    ...
    if (in_array($file_extension, $extensions)) {
        ...
        $sql = "UPDATE engii2 set id=$id,book_name='$bookname',book_prize='$bookprize',book_img='$uploadBookImg',product_quantity='$bookqty' where id=$id";
