...
$id= $_GET['updateid7'];
$sqldisplay4 = "SELECT * from accountancy where id = $id";
$resultdisplay4= mysqli_query($connect,$sqldisplay4);
$row4 = mysqli_fetch_assoc($resultdisplay4);
$bookname = $row4['book_name'];
$bookprize = $row4['book_prize'];
$bookimg = $row4['book_img'];
$bookqty = $row4['product_quantity'];
...
if (isset($_POST['update'])) {
    ...
    $bookimgfilename = $bookimg['name'];
    $bookimgerror = $bookimg['error'];
    $bookimgfiletemp = $bookimg['tmp_name'];

    $filename_seperate = explode('.', $bookimgfilename);
    ...
    if (in_array($file_extension, $extensions)) {
        ...
        $uploadBookImg = 'images/' . $bookimgfilename;
        move_uploaded_file($bookimgfiletemp, $uploadBookImg);

        $sql = "UPDATE accountancy set id=$id,book_name='$bookname',book_prize='$bookprize',book_img='$uploadBookImg',product_quantity='$bookqty' where id=$id";
        $sql2 = "UPDATE booksinvent2 set id=$id,book_name='$bookname',book_prize='$bookprize',book_img='$uploadBookImg',product_quantity='$bookqty' where id=$id";
        ...
        if ($result) {
            ...
            echo "<script>window.location = 'admin-dashboard7.php#section2'</script>";
            # code...
        } else {
            # code...
                ...
                <div class="col col-lg-10 col-md-12 col-sm-12 col-xs-12 ">
                    ...
                    <form method="post" class="border border-2 py-4 px-4 my-2 mx-2 shadow p-3 mb-5 bg-body rounded" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="book_name" placeholder="Enter Book Name" value="<?php echo $bookname ?>">

                        </div>
                        <div class="mb-3">
                            <label for="book_prize" class="form-label">Book Price</label>
                            <input type="text" class="form-control" name="book_prize" placeholder="Enter Book Price" value="<?php echo $bookprize ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="product_quantity" placeholder="Enter Quantity" value="<?php echo $bookqty ?>">
