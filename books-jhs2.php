    ...
    <section id="section2">
        ...
        <div class="container    py-5 my-3">
            ...
            <ul class="nav nav-pills nav-fill">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="books-jhs2.php#section2"><button type="button" class="btn btn btn-dark  w-100">Junior HighSchool</button></a>
                </li>
            </ul>
            <hr>
            <div id="filter" class="button-group text-end">
                <a href="books-jhs.php#section2"><button class="btn  " data-filter=".major">All Books</button></a>
                <a href="books-jhs2.php#section2"><button class="btn border border-2 " data-filter=".major">Grade 10</button></a>
                <a href="books-jhs3.php#section2"><button class="btn " data-filter=".major">Grade 9</button></a>
                <a href="books-jhs4.php#section2"><button class="btn " data-filter=".major">Grade 8</button></a>
                <a href="books-jhs5.php#section2"><button class="btn " data-filter=".major">Grade 7</button></a>
            ...
            <div class="row">
                ...
                <?php
                $sql = "SELECT * from g10 ORDER by ID asc";
