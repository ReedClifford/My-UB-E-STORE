      ...
      <div class="row">
            ...
            <div class="accordion-item">
              ...
              <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                  ...
                  <a class="nav-link active2" href="admin-dashboard15.php#section2">Grade 10</a>
        ...
        <div class="col col-lg-10 col-md-12 col-sm-12 mb-5  col-xs-12">
          <div class="d-flex justify-content-between bg-dark py-3 px-3 ">
            <h5 class="fw-bolder  text-white-50   fs-4">G10 Books</h5>
            <a href="addbooks15.php"> <button type="button" class="btn btn-warning text-white">
                Add Books
              </button></a>
          </div>
          <hr>
            ...
            <tbody>
              ...
              if ($result) {
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                  ...
                  <a href=\"adminupdate15.php?updateid15=$id\"> <button class=\"btn btn-success py-1 px-4 my-2\">Update</button></a>
                  <a href=\"admindelete15.php?deleteid15=$id\"> <button class=\"btn btn-danger py-1 px-4 my-2\">Delete</button></a>
