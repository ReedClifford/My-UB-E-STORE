...
// create instance
// $database2 = new engiiBooksDb("engii2", "engii2");
if (isset($_POST['add'])) {
  // print_r($_POST['book_id']);
  echo "<script>window.location = 'books2.php#section2'</script>";
  echo "<script>window.location = 'books2.php#section2'</script>";
  echo "<script>window.location = 'books2.php#section2'</script>";
...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark fixed-top   py-4 px-4">
    <div class="container-fluid"><img src="images/ubwhitelogo.png" alt="" width="160" height="45" class="d-inline-block align-text-top" /></a>
  ...
  <section id="section2">
    ...
    <div class="container    py-5 my-3">
      ...
      <div id="filter" class="button-group text-end">
        ...
        <a href="books2.php#section2"><button class="btn border border-2 " data-filter=".major">Engineering</button></a>
      ...
      <div class="row">
        ...
        <?php
        $sql = "SELECT * from engii2";
        $result = mysqli_query($connect, $sql);
        while ($row = mysqli_fetch_assoc($result)) {
          component2($row['book_name'], $row['book_prize'], $row['book_img'], $row['product_quantity'], $row['id']);
        }
