      ...
      <div class="row">
            ...
            <div class="accordion-item">
              ...
              <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                ...
                <a class="nav-link" href="admin-uniform2.php#section2">Junior High</a>
                  ...
                  <a class="nav-link active2" href="admin-uniform4.php#section2">College</a>
        ...
        <div class="col col-lg-10 col-md-12 col-sm-12 col-xs-12 ">
          <div class="d-flex justify-content-between bg-dark py-3 px-3">
            <h5 class="fw-bolder  text-white-50   fs-4">College Uniform  </h5>
            <a href="adduniform4.php"> <button type="button" class="btn btn-warning text-white"">
                Add New Item
              </button></a>
          </div>
          ...
          <table class="table border border-1 table-secondary table-hover table-stripped my-5">
            ...
            <tbody>
              ...
              $sql = "SELECT * from collegeuniform";
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<tr>
                      ...
                      <td class = \"text-center\">
                        <a href=\"adminuniformupdate4.php?updateuniid4=$id\"> <button class=\"btn btn-success py-1 px-4 my-2\">Update</button></a>
                        <a href=\"adminuniformdelete4.php?deleteuniid4=$id\"> <button class=\"btn btn-danger py-1 px-4 my-2\">Delete</button></a>
