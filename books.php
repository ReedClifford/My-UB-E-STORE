  ...
  <section id="section2">
    ...
    <div class="container    py-5 my-3">
      ...
      <div id="filter" class="button-group text-end">
        <a href="books.php#section2"><button class="btn border border-2 " data-filter=".major">All Books</button></a>
        ...
        <a href="books7.php#section2"><button class="btn " data-filter=".major">CBA</button></a>
      ...
      <div class="row">
        ...
        <?php
        $sql = "SELECT * from booksinvent2 ORDER by ID asc";
