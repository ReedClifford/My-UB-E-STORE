...
if (isset($_POST['add'])) {
    ...
    if (in_array($file_extension, $extensions)) {
        ...
        $sql = "INSERT into g8 (id,book_name,book_prize,book_img,product_quantity) 
        ...
        if ($result && $result2) {
            ...
            header("location:admin-dashboard17.php#section2");
            # code...
        } else {
            # code...
        ...
        <div class="container-fluid px-4 py-3">
            <div class="row">
                ...
                <div class="col col-lg-10 col-md-12 col-sm-12 col-xs-12 ">
                    ...
                    <h5 class="fw-bolder bg-dark text-white-50 py-3 px-3 fs-4 mt-5">Add G8 Books</h5>
                    <hr>
