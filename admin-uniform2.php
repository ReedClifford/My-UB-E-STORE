      ...
      <div class="row">
        <div class="col col-lg-2 col-md-12 col-sm-12 col-xs-12">
          <nav class="nav flex-column border border-1 mt-6 nav-pills navbar-light bg-light sticky-top">
            ...
            <div class="accordion-item">
              ...
              <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                  <a class="nav-link active2" href="admin-uniform2.php#section2">Junior High</a>
        ...
        <div class="col col-lg-10 col-md-12 col-sm-12 col-xs-12 ">
          <div class="d-flex justify-content-between bg-dark py-3 px-3">
            <h5 class="fw-bolder  text-white-50   fs-4">Junior Highschool</h5>
            <a href="adduniform2.php"> <button type="button" class="btn btn-warning text-white"">
                Add Uniform Item
              </button></a>
          </div>
                  ...
                  if ($result) {
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                      ...
                      <td class = \"text-center\">
                        <a href=\"adminuniformupdate2.php?updateuniid2=$id\"> <button class=\"btn btn-success py-1 px-4 my-2\">Update</button></a>
                        <a href=\"adminuniformdelete2.php?deleteuniid2=$id\"> <button class=\"btn btn-danger py-1 px-4 my-2\">Delete</button></a>
