...
if (isset($_POST['add'])) {
    ...
    $sql = "INSERT into booksinvent2 (id,book_name,book_prize,book_img,product_quantity) 
            ...
            <div class="row">
                <div class="col col-lg-2 col-md-12 col-sm-12 col-xs-12">
                    <nav class="nav flex-column border border-1 mt-5 nav-pills navbar-light bg-light ">
                        ...
                        <div class="bg-dark border  py-2 px-3">
                            <h6 class="fs-6 fw-normal text-white-50 text-wrap"><i class="fas fa-warehouse"></i> Inventory</h6>
                        </div>
                        


                        <a class="nav-link  bg-secondary text-white border" href="admin-dashboard.php">Books</a>
                ...
                <div class="col col-lg-10 col-md-12 col-sm-12 col-xs-12 ">
                    ...
                    <h5 class="fw-bolder bg-dark text-white-50 py-3 px-3 fs-4 mt-5">Add Book</h5>
                    <hr>
                    <form method="post" class="border border-2 py-4 px-4 my-2 mx-2">
                        <div class="mb-3">
