    ...
    <section id="section2">
        ...
        <div class="container    py-5 my-3">
            ...
            <div id="filter" class="button-group text-end">
                ...
                <a href="books-shs4.php#section2"><button class="btn border border-2" data-filter=".major">TechVoc</button></a>
            ...
            <div class="row">
                ...
                <?php
                $sql = "SELECT * from techvoc ORDER by ID asc";
