...
$id= $_GET['updateuniid2'];
$sqldisplay2 = "SELECT * from jhsuniform where id = $id";
...
if (isset($_POST['update2'])) {
    ...
    if (in_array($file_extension, $extensions)) {
        ...
        $sql = "UPDATE jhsuniform set id=$id,name='$uniformname',prize='$uniformprize',quantity='$uniformqty',uniform_img='$uploadUniformImg' where id=$id";
