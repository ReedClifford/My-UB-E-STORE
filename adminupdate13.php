...
$id= $_GET['updateid13'];
$sqldisplay4 = "SELECT * from techvoc where id = $id";
...
if (isset($_POST['update'])) {
    ...
    if (in_array($file_extension, $extensions)) {
        ...
        $sql = "UPDATE techvoc set id=$id,book_name='$bookname',book_prize='$bookprize',book_img='$uploadBookImg',product_quantity='$bookqty' where id=$id";
        ...
        if ($result) {
            ...
            echo "<script>window.location = 'admin-dashboard13.php#section2'</script>";
            # code...
        } else {
            # code...
