...
if (isset($_POST['add'])) {
    ...
    if (isset($_SESSION['cart'])) {
        ...
        echo "<script>window.location = 'uniformmain5.php#section2'</script>";
        if (in_array($_POST['uniform_id'], $uniform_item_id)) {


            echo "<script>alert('Product is already in the cart!!')</script>";
            echo "<script>window.location = 'uniformmain5.php'</script>";
        } else {
            # code...
...
<body>
    ...
    <section id="section2">
        ...
        <div class="container    py-5 my-3">
            <h4 class="fw-bolder fs-4">Junior Highschool</h4>
            <hr>
            <div id="filter" class="button-group text-end">
                <a href="uniformmain.php"><button class="btn  " data-filter=".major">All Items</button></a>
                ...
                <a href="uniformmain5.php"><button class="btn border border-2" data-filter=".major">Accesories</button></a>
            ...
            <div class="row">
                ...
                <?php
                $sql = "SELECT * from uniformaccesory ORDER by ID asc";
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    component5($row['name'], $row['prize'], $row['uniform_img'], $row['quantity'], $row['id']);
                }
