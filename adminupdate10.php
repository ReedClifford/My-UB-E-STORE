...
$id= $_GET['updateid10'];
$sqldisplay4 = "SELECT * from teched where id = $id";
...
if (isset($_POST['update'])) {
    ...
    if (in_array($file_extension, $extensions)) {
        ...
        $sql = "UPDATE teched set id=$id,book_name='$bookname',book_prize='$bookprize',book_img='$uploadBookImg',product_quantity='$bookqty' where id=$id";
        ...
        if ($result) {
            ...
            echo "<script>window.location = 'admin-dashboard10.php#section2'</script>";
            # code...
        } else {
            # code...
