      ...
      <div class="row">
            ...
            <div class="accordion-item">
              ...
              <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                ...
                <a class="nav-link" href="admin-uniform2.php#section2">Junior High</a>
                  <a class="nav-link active2" href="admin-uniform3.php#section2">Senior High</a>
        ...
        <div class="col col-lg-10 col-md-12 col-sm-12 col-xs-12 ">
          <div class="d-flex justify-content-between bg-dark py-3 px-3">
            <h5 class="fw-bolder  text-white-50   fs-4">Senior HighSchool Uniform  </h5>
            <a href="adduniform3.php"> <button type="button" class="btn btn-warning text-white"">
                Add Uniform Item
              </button></a>
          </div>
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<tr>
                      ...
                      <td class = \"text-center\">
                        <a href=\"adminuniformupdate3.php?updateuniid3=$id\"> <button class=\"btn btn-success py-1 px-4 my-2\">Update</button></a>
                        <a href=\"adminuniformdelete3.php?deleteuniid3=$id\"> <button class=\"btn btn-danger py-1 px-4 my-2\">Delete</button></a>
