    ...
    <section id="section2">
        ...
        <div class="container    py-5 my-3">
            ...
            <ul class="nav nav-pills nav-fill">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="books-shs2#section2.php"><button type="button" class="btn btn-dark w-100">Senior HighSchool</button></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="books-jhs2#section2.php"><button type="button" class="btn btn-outline-dark w-100">Junior HighSchool</button></a>
                </li>
            </ul>
            <hr>
            <div id="filter" class="button-group text-end">
                <a href="books-shs.php#section2"><button class="btn border border-2 " data-filter=".major">All Books</button></a>
                ...
                <a href="books-shs5.php#section2"><button class="btn  " data-filter=".major">SHS General Education</button></a>
