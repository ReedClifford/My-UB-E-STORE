      ...
      <div class="row">
            ...
            <div class="accordion-item">
              ...
              <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                  ...
                  <a class="nav-link active2" href="admin-uniform5.php#section2">Accesories</a>
                </div>
              </div>
            </div>
        ...
        <div class="col col-lg-10 col-md-12 col-sm-12 col-xs-12 ">
          <div class="d-flex justify-content-between bg-dark py-3 px-3">
            <h5 class="fw-bolder  text-white-50   fs-4">Add New Item  </h5>
            <a href="adduniform5.php"> <button type="button" class="btn btn-warning text-white"">
                Add New Item
              </button></a>
          </div>
          ...
          <table class=" table border border-1 table-secondary table-hover table-stripped my-5">
                ...
                <tbody>
                  ...
                  $sql = "SELECT * from uniformaccesory";
                  ...
                  if ($result) {
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                      ...
                      <td class = \"text-center\">
                        <a href=\"adminuniformupdate5.php?updateuniid5=$id\"> <button class=\"btn btn-success py-1 px-4 my-2\">Update</button></a>
                        <a href=\"adminuniformdelete5.php?deleteuniid5=$id\"> <button class=\"btn btn-danger py-1 px-4 my-2\">Delete</button></a>
