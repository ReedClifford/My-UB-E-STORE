    ...
    <section id="section2">
        ...
        <div class="container    py-5 my-3">
            ...
            <div id="filter" class="button-group text-end">
                ...
                <a href="books-shs2.php#section2"><button class="btn  border border-2 " data-filter=".major">STEM</button></a>
            ...
            <div class="row">
                ...
                <?php
                $sql = "SELECT * from stem ORDER by ID asc";
