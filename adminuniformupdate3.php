...
$id= $_GET['updateuniid3'];
$sqldisplay2 = "SELECT * from shsuniform where id = $id";
...
if (isset($_POST['update3'])) {
    ...
    if (in_array($file_extension, $extensions)) {
        ...
        $sql = "UPDATE shsuniform set id=$id,name='$uniformname',prize='$uniformprize',quantity='$uniformqty',uniform_img='$uploadUniformImg' where id=$id";
