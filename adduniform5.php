...
if (isset($_POST['add'])) {
    ...
    if (in_array($file_extension, $extensions)) {
        ...
        $sql = "INSERT into uniforminvent (id,name,prize,quantity,uniform_img) 
        values('$uniformid','$uniformname','$uniformprize','$uniformqty','$uploadUniformImg')";
        $sql2 = "INSERT into uniformaccesory (id,name,prize,quantity,uniform_img) 
        values('$uniformid','$uniformname','$uniformprize','$uniformqty','$uploadUniformImg')";
        ...
        <div class="container-fluid px-4 py-3">
            <div class="row">
                ...
                <div class="col col-lg-10 col-md-12 col-sm-12 col-xs-12 ">
                    ...
                    <h5 class="fw-bolder bg-dark text-white-50 py-3 px-3 fs-4 mt-5">Add Item</h5>
                    <hr>
                    <!-- FORM -->
                    <form method="post" class="border border-2 py-4 px-4 my-2 mx-2 shadow p-3 mb-5 bg-body rounded mb-5 " enctype="multipart/form-data">
                        <div class="mb-3">
                            <label class="form-label">Id</label>
                            <input type="number" class="form-control" name="id" placeholder="Enter  Name">
                        ...
                        <div class="mb-3">
                            <label for="book_prize" class="form-label">Item Price</label>
                            <input type="text" class="form-control" name="prize" placeholder="Enter  Price">
