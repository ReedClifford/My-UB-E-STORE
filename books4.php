...
// include_once "include/fetchbooks1.php";
// print_r($books);
...
// create instance
// $database4 = new genEdBooks("gened2", "gened2");
if (isset($_POST['add'])) {
  // print_r($_POST['book_id']);

  if (isset($_SESSION['cart'])) {
    # code...
    $book_item_id4 = array_column($_SESSION['cart'], "book_id");
    echo "<script>window.location = 'books4.php#section2'</script>";
    if (in_array($_POST['book_id'], $book_item_id4)) {
      # code...
      ...
      $_SESSION['cart'][$count4] = $book_array4;
    }
  } else {
    # code...
    $book_array4 = array(
...
<body>
  ...
  <section id="section2">
    ...
    <div class="container    py-5 my-3">
      ...
      <li class="nav-item">
          <a class="nav-link" aria-current="page" href="books2.php#section2"><button type="button" class="btn btn-dark w-100">College</button></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="books-shs2.php#section2"><button type="button" class="btn btn-outline-dark w-100">Senior HighSchool</button></a>
        </li>
        <li class="nav-item">
      ...
      <div id="filter" class="button-group text-end">
        <a href="books.php#section2"><button class="btn   " data-filter=".major">All Books</button></a>
        <a href="books2.php#section2"><button class="btn " data-filter=".major">Engineering</button></a>
        <a href="books3.php#section2"><button class="btn " data-filter=".major">Nursing</button></a>
        <a href="books4.php#section2"><button class="btn border border-2" data-filter=".major">General Education</button></a>
        <a href="books5.php#section2"><button class="btn " data-filter=".major">CAS</button></a>
        <a href="books6.php#section2"><button class="btn " data-filter=".major">CICT</button></a>
        <a href="books7.php#section2"><button class="btn " data-filter=".major">Accountancy</button></a>
        <a href="books8.php#section2"><button class="btn " data-filter=".major">Criminology</button></a>
        <a href="books9.php#section2"><button class="btn " data-filter=".major">Tourism</button></a>
        <a href="books10.php#section2"><button class="btn " data-filter=".major">TechEd</button></a>
      ...
      <div class="row">
        ...
        <?php
        $sql = "SELECT * from gened2";
        $result = mysqli_query($connect, $sql);
        while ($row = mysqli_fetch_assoc($result)) {
          component4($row['book_name'], $row['book_prize'], $row['book_img'], $row['product_quantity'], $row['id']);
        }
      ...
      <div id="filter" class="button-group text-end">
        <a href="books.php#section2"><button class="btn  " data-filter=".major">All Books</button></a>
        <a href="books2.php#section2"><button class="btn " data-filter=".major">Engineering</button></a>
        <a href="books3.php#section2"><button class="btn border border-2 " data-filter=".major">Nursing</button></a>
        <a href="books4.php#section2"><button class="btn " data-filter=".major">General Education</button></a>
        <a href="books5.php#section2"><button class="btn " data-filter=".major">CAS</button></a>
        <a href="books6.php#section2"><button class="btn " data-filter=".major">CICT</button></a>
        <a href="books7.php#section2"><button class="btn " data-filter=".major">Accountancy</button></a>
        <a href="books8.php#section2"><button class="btn " data-filter=".major">Criminology</button></a>
