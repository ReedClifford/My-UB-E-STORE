...
$id= $_GET['updateid8'];
$sqldisplay4 = "SELECT * from criminology where id = $id";
...
if (isset($_POST['update'])) {
    ...
    if (in_array($file_extension, $extensions)) {
        ...
        $sql = "UPDATE criminology set id=$id,book_name='$bookname',book_prize='$bookprize',book_img='$uploadBookImg',product_quantity='$bookqty' where id=$id";
        ...
        if ($result) {
            ...
            echo "<script>window.location = 'admin-dashboard8.php#section2'</script>";
            # code...
        } else {
            # code...
