      ...
      <div class="row">
            ...
            <div class="accordion-item">
              ...
              <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                  ...
                  <a class="nav-link active2" href="admin-dashboard5.php#section2">CAS</a>
        ...
        <div class="col col-lg-10 col-md-12 col-sm-12 mb-5  col-xs-12">
          <div class="d-flex justify-content-between bg-dark py-3 px-3 ">
            <h5 class="fw-bolder  text-white-50   fs-4">CAS Books</h5>
            <a href="addbooks5.php"> <button type="button" class="btn btn-warning text-white">
                Add Books
              </button></a>
          </div>
          <hr>
            ...
            <tbody>
              ...
              if ($result) {
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                  ...
                  <a href=\"adminupdate5.php?updateid5=$id\"> <button class=\"btn btn-success py-1 px-4 my-2\">Update</button></a>
                  <a href=\"admindelete5.php?deleteid5=$id\"> <button class=\"btn btn-danger py-1 px-4 my-2\">Delete</button></a>
