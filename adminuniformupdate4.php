...
$id= $_GET['updateuniid4'];
$sqldisplay2 = "SELECT * from collegeuniform where id = $id";
...
if (isset($_POST['update4'])) {
    ...
    if (in_array($file_extension, $extensions)) {
        ...
        $sql = "UPDATE collegeuniform set id=$id,name='$uniformname',prize='$uniformprize',quantity='$uniformqty',uniform_img='$uploadUniformImg' where id=$id";
