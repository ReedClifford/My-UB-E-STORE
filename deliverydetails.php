    ...
    <div class="container-fluid px-4 py-3">
      <div class="row">
        <div class="col col-lg-2">
          <nav class="nav flex-column border border-1 mt-5 nav-pills navbar-light bg-light sticky-top">
            <div class="bg-dark border  py-2 px-3">
              <h4 class="fs-3 fw-bold text-white-50"><i class="fas fa-user-shield "></i> Admin</h4>
            </div>
            <div class="bg-dark border  py-2 px-3">
              <a href="admin-dashboard.php" class="navlink">
                <h6 class="fs-6 fw-normal text-white-50 text-wrap"><i class="fas fa-book-open me-2"></i> Books Inventory</h6>
              </a>
            </div>
            ...
            <div class="accordion-item">
              ...
              <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                  ...
                  <a class="nav-link " href="admin-dashboard3.php#section2">Nursing</a>
                  ...
                  <a class="nav-link" href="admin-dashboard14.php#section2">Grade 10</a>
                  <a class="nav-link" href="admin-dashboard15.php#section2">Grade 9</a>
                  <a class="nav-link" href="admin-dashboard16.php#section2">Grade 8</a>
                  <a class="nav-link" href="admin-dashboard17.php#section2">Grade 7</a>
                </div>
              </div>
            </div>
            <div class="bg-dark border  py-2 px-3">
              <a href="admin-uniform.php#section2" class="navlink">
        ...
        <div class="col col-lg-10  ">
          <h5 class="fw-bolder bg-dark text-white-50 py-3 px-3 fs-4 mt-5">Delivery Details</h5>
          <hr>
          <div class="container">
            <table id="delivery" class="table border border-1 table-danger table-hover table-stripped my-5">
              <thead class="w-100">
                <tr>
              ...
              <tbody>
                ...
                $sql = "SELECT * from delivery_info2";
                ...
                if ($result) {
                  ...
                  <td>$contact</td>
                  <td>$address</td>
                  <td class=\"text-center\">$booksid</td>
                  <td class=\"text-center\">$uniformid</td>
                  <td>$date</td>
                  <td>
                 
                  <a href=\"deliverydelete.php?deleteid=$id\"> <button class=\"btn btn-danger py-1 px-4 my-2\">On Delivery</button></a>
          ...
          <!-- <a href="addbooks.php"> <button type="button" class="btn btn-dark px-4 ms-3">
              Add Books
            </button></a> -->
