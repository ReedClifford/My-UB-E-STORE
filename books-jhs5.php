    ...
    <section id="section2">
        ...
        <div class="container    py-5 my-3">
            ...
            <div id="filter" class="button-group text-end">
                ...
                <a href="books-jhs2.php#section2"><button class="btn  " data-filter=".major">Grade 10</button></a>
                ...
                <a href="books-jhs5.php#section2"><button class="btn border border-2" data-filter=".major">Grade 7</button></a>
            ...
            <div class="row">
                ...
                <?php
                $sql = "SELECT * from g7 ORDER by ID asc";
